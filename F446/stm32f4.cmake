...
set(STM32F446_STDPERIPH_SRC ${STM32F4_STDPERIPH_SRC})
set(STM32F446_STDPERIPH_SRC_EXCLUDES "stm32f4xx_fsmc.c")
exclude_basenames(STM32F446_STDPERIPH_SRC ${STM32F446_STDPERIPH_SRC_EXCLUDES})

set(STM32F446_COMPILE_DEFINITIONS
    STM32F446xx
    MCU_FLASH_SIZE=512
    OPTIMIZATION -Os
)

function(target_stm32f446xe name)
    target_stm32f4xx(
        NAME ${name}
        STARTUP startup_stm32f446xx.s
        SOURCES ${STM32F446_STDPERIPH_SRC}
        COMPILE_DEFINITIONS ${STM32F446_COMPILE_DEFINITIONS}
        LINKER_SCRIPT stm32_flash_f446xe
        SVD STM32F446
        ${ARGN}
    )
endfunction()
